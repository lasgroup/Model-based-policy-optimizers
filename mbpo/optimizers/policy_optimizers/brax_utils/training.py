...
from mbpo.systems.brax_wrapper import BraxWrapper as Env
...
class VmapWrapper(Wrapper):
    ...
    def reset(self, rng: jp.ndarray) -> State:
        ...
        return jax.vmap(self.env.reset, out_axes=self.vmap_axes)(rng)

    def step(self, state: State, action: jp.ndarray) -> State:
        return jax.vmap(self.env.step,
                        in_axes=(self.vmap_axes, 0),
                        out_axes=self.vmap_axes)(state, action)
